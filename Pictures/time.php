...
<td colspan=4 style="text-align: center;">
    ...
    <table class="table_welcome" border="l" width="700px" style="margin-top:5px; float:left;margin-right:600px;position:absolute;">
  ...
  if($Seat_N>=1){
    ...
    echo "</td></tr>";
     ...
     echo "<h1 style='text-align:center; color:white;padding:5px; background-color:tan;border:5px red groove;'>";
     echo " <a href='Deal_Motivation.php'>";
